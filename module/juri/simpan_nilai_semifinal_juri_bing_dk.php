              ...
              <div class="row">
                <div class="col-md-12">
                    <?php  
						...
						$query_update = "UPDATE alternatif SET s_k1_bing='sudah' WHERE alternatif='$nim'";
						$hasil_update = mysqli_query($koneksi, $query_update);

						$query_update_status_k2a = mysqli_query($koneksi, "UPDATE alternatif SET `k1_bing`='$dinamika_kelompok' WHERE `alternatif`='$nim'");
						...
						echo "<script>window.location.href = '?module=nilai_semifinal_dinamika_kelompok';</script>";
