            	...
            	<div class="col-md-6">                   
					...
					<div class="panel-body">
							...
							<?php							
								...
								echo "</table><hr>";
								//vektor v
								echo "<b style='color:#ffffff;'>Perhitungan Vektor V</b></br>";
								echo "<table class='table table-striped table-bordered table-hover' style='background-color: #bb9e5d;'>";
								echo "<thead style='background-color: #8A2BE2;'><tr><th>Alternatif</th><th>V</th></tr></thead>";
								$total = 0;
								for($i=0;$i<$a;$i++){
									$total = $total + $ss[$i];
								}
								...
								uasort($v,'cmp');
									...
									echo "</table><hr>";
											...
											function jml_alternatif(){	
												include 'module/koneksi.php';
												$alternatif = mysqli_query($koneksi, "select * from alternatif where jk='L'");
							...
							<div class="panel-body">
								...
								<?php							
									...
									echo "<b style='color:#ffffff;'>Perhitungan Vektor V</b></br>";
									echo "<table class='table table-striped table-bordered table-hover' style='background-color: #bb9e5d;'>";
									echo "<thead style='background-color: #DAA520;'><tr><th>Alternatif</th><th>V</th></tr></thead>";
									$total = 0;
									for($i=0;$i<$s_p;$i++){
										$total = $total + $ss[$i];
									}
									...
									uasort($v,'cmp');
										...
										function jml_alternatif_p(){	
											include 'module/koneksi.php';
											$alternatif_p = mysqli_query($koneksi, "select * from alternatif where jk='P'");
