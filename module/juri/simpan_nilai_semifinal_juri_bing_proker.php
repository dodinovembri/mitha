              ...
              <div class="row">
                <div class="col-md-12">
                    <?php  
						...
						// $query = "INSERT INTO alternatif (`alternatif`, `k1`, `k2a`, `k3`) VALUES ('$nim', '$dinamika_kelompok', '$bahasa_inggris', '$proker')";
						// $hasil = mysqli_query($koneksi, $query);

						$query_update_status_k2a = mysqli_query($koneksi, "UPDATE alternatif SET `k3_bing`='$proker', `s_k3_bing`='sudah' WHERE `alternatif`='$nim'");
