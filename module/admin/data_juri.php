            ...
            <li>
                ...
                <ul class="dropdown-menu">
                  ...
                  <br>
                        ...
                        $sqlSelect = "SELECT user.*, role.role as role FROM user join role on user.id_role = role.id_role  where role.id_role=2 or role.id_role=4 or role.id_role=5 or role.id_role=6 or role.id_role=7";
