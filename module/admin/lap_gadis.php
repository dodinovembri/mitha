        ...
        <div class="col-md-12">
          <div class="mu-reservation-area">
            ...
            <div class="mu-reservation-content">
              <a href="module/admin/cetak_lap_gadis.php" target="_blank"><button type="button" class="btn btn-primary">Cetak Laporan</button></a><br>
              <?php
              ...
              <table id="example" class="table" cellspacing="0" width="100%" style="background-color: #bb9e5d;">
                <h3 style="color: white">Data Peserta Gadis Diterima</h3>
                            <thead>
                                <tr>                                    
                                    <th>No Peserta</th>                                   
                                    <th>Nama</th>                                                                
            ...
            <div class="mu-reservation-content">
              <?php
                        ...
                        $result = mysqli_query($koneksi, $sqlSelect); ?>
              <table id="example" class="table" cellspacing="0" width="100%" style="background-color: #bb9e5d;">
                <h3 style="color: white">Data Peserta Gadis Ditolak</h3>
                            <thead>
                                <tr>                                    
                                    <th>No Peserta</th>                                   
                                    <th>Nama</th>                                                                
