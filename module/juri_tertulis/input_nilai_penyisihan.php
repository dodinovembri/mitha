    ...
    <div class="container">
      ...
      <div class="col-md-12">               
                ...
                <?php  
                  ...
                  if ($id_role == 8) { ?>
                    <form class="form-horizontal" style="color:cornsilk" action="?module=simpan_nilai_tertulis" method="post"> 
                      <div class="box-body">
                        <input type="hidden" name="nim" value="<?php echo $nim; ?>">
                                ...
                                <div class="form-group">
                                 ...
                                 <div class="form-group">
                                  <label for="inputEmail3" class="col-sm-2 control-label">Test Tertulis</label>

                                  <div class="col-sm-10">
                                    <input type="number" min="0" max="100" name="tertulis" class="form-control" placeholder="Nilai Test Tertulis" required>                                  
                                  </div>
                                </div> 
