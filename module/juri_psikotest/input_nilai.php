          ...
          <div class="mu-reservation-area">
            ...
            <div class="mu-reservation-content">
                <?php
                 ...
                 if ($_SESSION['id_role'] == 9) {
                   include 'module/koneksi.php';
                        $sqlSelect = "SELECT * FROM peserta WHERE `s_juri_psikotest`='belum'";
                 ...
                 <table id="example" class="table table-striped table-bordered" cellspacing="0" width="100%" style="background-color: #bb9e5d;">
                    ...
                    ?>                                            
                            <tr>
                                ...
                                <td>                                  
                                  <a href="?module=input_nilai_psikotest&nim=<?php echo $row['nim']; ?>"><button type="button" class="btn btn-primary">Input Nilai</button></a>                                                  
                                </td>
                            </tr>
                    <?php
                        }
