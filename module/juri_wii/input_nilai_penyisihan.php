    ...
    <div class="container">
      ...
      <div class="col-md-12">               
                ...
                <?php  
                  ...
                  if ($id_role == 10) { ?>
                    <form class="form-horizontal" style="color:cornsilk" action="?module=simpan_nilai_wii" method="post"> <div class="box-body">
                        <input type="hidden" name="nim" value="<?php echo $nim; ?>">
                                ...
                                <div class="form-group">
                                 ...
                                 <div class="form-group">
                                  <label for="inputEmail3" class="col-sm-2 control-label">Walk In Interview</label>

                                  <div class="col-sm-10">
                                    <input type="number" min="50" max="90" name="wii" class="form-control" placeholder="Nilai Test Walk In Interview 50-90" required>                                  
                                  </div>
                                </div> 
