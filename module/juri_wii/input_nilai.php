            ...
            <div class="mu-reservation-content">
                 ...
                 if ($_SESSION['id_role'] == 10) {
                   include 'module/koneksi.php';
                        $sqlSelect = "SELECT * FROM peserta WHERE `s_juri_wii`='belum'";
                ...
                <div class="panel-body table-responsive">
                      <table id="example" class="table table-striped table-bordered" cellspacing="0" width="100%" style="background-color: #bb9e5d;">
                       ...
                       elseif ($_SESSION['id_role'] == 4) {
                          include 'module/koneksi.php';
                              $sqlSelect = "SELECT * FROM peserta WHERE `s_juri_psiko`='belum'";
                              $result = mysqli_query($koneksi, $sqlSelect); ?>
                          ...
                          ?>                                            
                                  <tr>
                                      ...
                                      <td><?php  echo $row['jurusan']; ?></td>
                                      <td>                                  
                                        <a href="?module=input_nilai_semifinal&nim=<?php echo $row['nim']; ?>"><button type="button" class="btn btn-primary">Input Nilai</button></a>                                                  
                                      </td>
                                  </tr>
                          <?php
                        } 
                       ...
                       elseif ($_SESSION['id_role'] == 5) {
                          include 'module/koneksi.php';
                              $sqlSelect = "SELECT * FROM peserta WHERE `s_juri_akademik`='belum'";
                              $result = mysqli_query($koneksi, $sqlSelect); ?>
                      ...
                      elseif ($_SESSION['id_role'] == 6) {
                          include 'module/koneksi.php';
                              $sqlSelect = "SELECT * FROM peserta WHERE `s_juri_kebudayaan`='belum'";
                              $result = mysqli_query($koneksi, $sqlSelect); ?>
                      ...
                      elseif ($_SESSION['id_role'] == 7) {
                          include 'module/koneksi.php';
                              $sqlSelect = "SELECT * FROM peserta WHERE `s_juri_kepemudaan`='belum'";
                              $result = mysqli_query($koneksi, $sqlSelect); ?>
